programa
{
    ...
    funcao real escolherSanduiche(cadeia sanduiches[], real precos[], real total)
    {
        ...
        se (escolher >= 1 e escolher <= 3) {
            ...
            se (quantidade > 0) {
                total = total + (precos[escolher - 1] * quantidade)
                escreva(quantidade, "x ", sanduiches[escolher - 1], " adicionado ao pedido.\n")
            } senao {
    ...
    funcao real escolherBebida(cadeia bebidas[], real precos[], real total)
    {
        ...
        se (escolher >= 1 e escolher <= 3) {
            ...
            se (quantidade > 0) {
                total = total + (precos[escolher - 1] * quantidade)
                escreva(quantidade, "x ", bebidas[escolher - 1], " adicionada ao pedido.\n")
            } senao {
                escreva("Quantidade inválida.\n")
            }
        } senao {
    ...
    funcao real escolherBatata(cadeia batatas[], real precos[], real total)
    {
        ...
        se (escolher >= 1 e escolher <= 3) {
            ...
            se (quantidade > 0) {
                total = total + (precos[escolher - 1] * quantidade)
                escreva(quantidade, "x Batata ", batatas[escolher - 1], " adicionada ao pedido.\n")
            } senao {
                escreva("Quantidade inválida.\n")
            }
        } senao {
